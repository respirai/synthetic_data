...
train_set = [
            # TODO: uncomment
            101, 106, 108, 109, 112, 114, 115, 116, 118, 119, 122, 124, 201, 203, 205, 207, 208, 209, 215, 220,
             223, 230]  # DS1
train_set = [str(x) for x in train_set]
test_set = [
            # TODO: uncomment
            100, 103, 105, 111, 113, 117, 121, 123, 200, 202, 210, 212, 213, 214, 219, 221, 222, 228, 231, 232,
            233, 234]  # DS2
...
class Patient(object):
    ...
    def get_annotations(self):
        ...
        :return:
        """
        ann = wfdb.rdann(self.patient_number, 'atr', pn_dir='mitdb', return_label_elements=['symbol', 'label_store',
                                                                                            'description'],
